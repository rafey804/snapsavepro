        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed max-w-md">
              Professional multi-platform video downloader supporting YouTube, Instagram, TikTok, and Facebook. 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/pages/how-it-works" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">How it Works</a></li>
              <li><a href="/pages/faqs" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">FAQ</a></li>
              <li><a href="/pages/contact" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/pages/legal/privacy-policy" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Privacy Policy</a></li>
              <li><a href="/pages/legal/terms-of-service" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Terms of Service</a></li>
              <li><a href="/pages/contact" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Support</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-700 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-gray-300 text-sm">
              © {currentYear} Downloader Pro. All rights reserved.
            </div>
