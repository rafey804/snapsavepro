...
export default function ProfessionalHeader() {
  ...
  const platforms: Platform[] = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          <path d="M10 14.65v-5.3L15 12l-5 2.65zm7.77-4.33c-.77-.32-1.2-.5-1.2-.5L18 9.26c1.01-.38 1.53-.5 1.53-.5.42-.14.93-.06 1.25.26.3.31.37.79.18 1.18-.1.21-.27.38-.48.48l-1.71.74M11.5 9c.22 0 .42.15.48.36l.5 1.79c.05.18 0 .39-.14.54-.13.14-.34.21-.54.16l-1.78-.5c-.21-.06-.36-.26-.36-.48 0-.28.22-.5.5-.5h1.11l-.33-.16-.15-.12c-.14-.14-.2-.35-.14-.54l.33-1.11c.06-.21.26-.36.48-.36M11 18.5c0 .28-.22.5-.5.5s-.5-.22-.5-.5v-1c0-.28.22-.5.5-.5s.5.22.5.5v1zm-2.29.08c-.08.15-.26.23-.43.23-.1 0-.2-.03-.3-.09-.23-.14-.3-.42-.16-.65l.5-.87c.14-.23.42-.3.65-.16s.3.42.16.65l-.5.87z"/>
        </svg>
      ),
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 lg:h-16">
            ...
            <button
              ...
              className="lg:hidden p-2 bg-slate-800/80 rounded-lg text-gray-300 hover:bg-slate-700/80 hover:text-white transition-all duration-200 ml-auto"
