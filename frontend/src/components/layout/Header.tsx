        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <nav className="hidden lg:flex items-center gap-1 ml-auto">
              ...
              >
                <button
                  className={`px-4 py-2.5 text-sm font-medium rounded-lg flex items-center gap-2 transition-all duration-300 ${activeDropdown === 'downloaders'
              ...
              >
                <button
                  className={`px-4 py-2.5 text-sm font-medium rounded-lg flex items-center gap-2 transition-all duration-300 ${activeDropdown === 'resources'
              ...
              <Link
                href="/blog"
                className={`px-4 py-2.5 text-sm font-medium rounded-lg flex items-center gap-2 transition-all duration-300 ${pathname === '/blog'
          ...
          {/* Mobile Navigation */}
          <div className={`lg:hidden transition-all duration-300 ease-in-out ${mobileMenuOpen ? 'max-h-[85vh] pb-4 overflow-y-auto' : 'max-h-0 overflow-hidden'
            }`}>
            <div className="pt-4 space-y-4">
              ...
              <div>
                ...
                {activeDropdown === 'mobile-downloaders' && (
                  <div className="mt-2 space-y-2 pl-4 max-h-[50vh] overflow-y-auto pr-2">
                    {downloaderItems.map((item) => (
                      <Link
                        key={item.route}
                        href={item.route}
