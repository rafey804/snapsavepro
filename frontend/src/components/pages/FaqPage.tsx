...
export default function FAQPage() {
    ...
    const categories = [
        ...
        { id: 'download', name: 'Download Process', icon: <Download className="h-5 w-5" /> },
        { id: 'quality', name: 'Video Quality', icon: <FileVideo className="h-5 w-5" /> },
        { id: 'audio', name: 'Audio & MP3', icon: <Music className="h-5 w-5" /> },
        { id: 'technical', name: 'Technical Issues', icon: <Monitor className="h-5 w-5" /> },
        { id: 'legal', name: 'Legal & Safety', icon: <Shield className="h-5 w-5" /> },
        { id: 'platforms', name: 'Platforms', icon: <Globe className="h-5 w-5" /> },
        { id: 'features', name: 'Features', icon: <Star className="h-5 w-5" /> }
    ];

    const faqData: Record<string, Array<{ question: string; answer: string; keywords: string }>> = {
        general: [
            {
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-8">
                        {categories.map((category) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all duration-300 ${activeCategory === category.id
