...
const DailymotionDownloader: React.FC = () => {
  const t = useTranslations('dailymotion');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate Dailymotion URL - More flexible pattern to accept various Dailymotion URL formats
    const dailymotionRegex = /dailymotion/i;
    if (!dailymotionRegex.test(url.trim())) {
    ...
    try {
      ...
      console.log('Dailymotion API Response:', data);
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-8">
      {/* Header Section with Dailymotion Theme (Orange/Yellow) */}
      <div className="text-center mb-12 animate-fade-in">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-blue-500 bg-clip-text text-transparent animate-gradient">
            {t('title')}
          </h1>
        </div>
      ...
      <form onSubmit={handleSubmit} className="mb-8 block md:hidden space-y-3">
        <div className="relative">
          <input
            ...
            className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-slate-800/50 border border-blue-500/30 rounded-xl sm:rounded-2xl text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 backdrop-blur-xl transition-all text-sm sm:text-base pr-12"
            disabled={isLoading}
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                e.preventDefault();
        ...
        <div className="flex gap-3 items-center">
          <div className="relative flex-1">
            <input
              ...
              onChange={(e) => setUrl(e.target.value)}
              placeholder={t('placeholder')}
              className="w-full px-6 py-4 bg-slate-800/50 border border-blue-500/30 rounded-2xl text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 backdrop-blur-xl transition-all pr-12"
              disabled={isLoading}
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  e.preventDefault();
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-semibold text-white flex items-center gap-2">
                  {downloadMode === 'video' ? <Video className="w-5 h-5 text-blue-400" /> : <Music className="w-5 h-5 text-purple-400" />}
                ...
                {(() => {
                  ...
                  if (!currentFormats || currentFormats.length === 0) {
                    return (
                      <div className="p-6 bg-slate-900/50 rounded-xl border border-purple-500/20 text-center">
                  ...
                  return currentFormats.map((format, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="p-4 bg-slate-900/50 rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all"
