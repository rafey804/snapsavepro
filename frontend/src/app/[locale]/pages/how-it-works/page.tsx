...
export default function HowItWorksPage() {
  ...
  return (
    <>
      <Head>
        <title>How It Works - Free YouTube Video Downloader Guide | Step by Step</title>
        <meta name="description" content="Learn how to download YouTube videos in 4 easy steps. Complete guide for downloading HD, 4K videos and MP3 audio. Free, fast, and secure process." />
        <meta name="keywords" content="how to download youtube videos, youtube downloader guide, download youtube step by step, youtube to mp4 tutorial, youtube mp3 converter guide" />
      </Head>
